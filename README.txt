...
- Edit line 49 of InstRom.sv to include the machine code file you want to use (my current code uses an absolute path)
	- For program 1, use machine1.txt
	- For program 2, use machine2.txt
	- For program 3, use machine3.txt
...
- Pick the design unit that you want to test
	...
	- For program 3, select work.test_bench_prod3. I couldn't get program 3 to work but you can try to run it anyways.
- Click run -all
- The transcript should show the results of the test

Something to know:
- The LUT doesn't do anything but it is required so that the processor runs properly.