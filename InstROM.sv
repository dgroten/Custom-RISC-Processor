...
// declare 2-dimensional array, W bits wide, 2**A words deep
  ...
  initial begin		                  // load from external text file
  	$readmemb("C:\\Users\\Daniel\\Desktop\\CSE 141L\\NARM\\machine2.txt",inst_rom);
  end 
  
endmodule

// Changed parameter W from 10 to 9 (9 bit machine code)
// In the future, change parameter A based on how many instructions are needed